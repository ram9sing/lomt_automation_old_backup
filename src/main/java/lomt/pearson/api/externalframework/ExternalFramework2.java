...
public class ExternalFramework2 extends BaseClass {
	...
	public void heBrowsePage(ExtentTest logger, String mappingName) {
		if (!mappingName.equalsIgnoreCase(ExternalFrameworkTestData.RE_INGESTION+ExternalFrameworkTestData.HE)) {
			try {
				//INGESTION
		...
		if (testCaseName.equalsIgnoreCase(LOMTConstant.REINGESTION_WRONG_GRADE_SAME_LEVEL)) {
			try {
				if (exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_3_ERROR_MESSAGE)
						|| exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_3_ERROR_MESSAGE)
						...
						|| exfPOM.getErrorRowSix().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_3_ERROR_MESSAGE) 
						|| exfPOM.getErrorRowSeven().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_3_ERROR_MESSAGE)
						|| exfPOM.getErrorRowEight().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_3_ERROR_MESSAGE)) {
					flag = true;
				}
				if (exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_3)
						|| exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_3)
						...
						|| exfPOM.getErrorRowSix().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_3) 
						|| exfPOM.getErrorRowSeven().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_3)
						|| exfPOM.getErrorRowEight().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_3)) {
					flag = true;
				}
				if (exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.LEVEL_3_INCORRECT_ERROR_MESSAGE)
						|| exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.LEVEL_3_INCORRECT_ERROR_MESSAGE)
						...
						|| exfPOM.getErrorRowSix().getText().equalsIgnoreCase(LOMTConstant.LEVEL_3_INCORRECT_ERROR_MESSAGE) 
						|| exfPOM.getErrorRowSeven().getText().equalsIgnoreCase(LOMTConstant.LEVEL_3_INCORRECT_ERROR_MESSAGE)
						|| exfPOM.getErrorRowEight().getText().equalsIgnoreCase(LOMTConstant.LEVEL_3_INCORRECT_ERROR_MESSAGE)) {
					flag = true;
				}
				if (exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_4)
						|| exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_4)
						...
						|| exfPOM.getErrorRowSix().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_4) 
						|| exfPOM.getErrorRowSeven().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_4)
						|| exfPOM.getErrorRowEight().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_4)) {
					flag = true;
				}
				if (exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_5)
						|| exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_5)
						|| exfPOM.getErrorRowTwo().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_5)
						|| exfPOM.getErrorRowThree().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_5)
						|| exfPOM.getErrorRowFour().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_5)
						|| exfPOM.getErrorRowFive().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_5)
						|| exfPOM.getErrorRowSix().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_5) 
						|| exfPOM.getErrorRowSeven().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_5)
						|| exfPOM.getErrorRowEight().getText().equalsIgnoreCase(LOMTConstant.GRADE_LOW_ROW_5)) {
					flag = true;
				}
				if (exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_16)
						|| exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_16)
						|| exfPOM.getErrorRowTwo().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_16)
						|| exfPOM.getErrorRowThree().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_16)
						|| exfPOM.getErrorRowFour().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_16)
						|| exfPOM.getErrorRowFive().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_16)
						|| exfPOM.getErrorRowSix().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_16) 
						|| exfPOM.getErrorRowSeven().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_16)
						|| exfPOM.getErrorRowEight().getText().equalsIgnoreCase(LOMTConstant.MULTIPLE_LEVEL_ROW_16)) {
					flag = true;
				}
				if (exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_16)
						|| exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_16)
						|| exfPOM.getErrorRowTwo().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_16)
						|| exfPOM.getErrorRowThree().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_16)
						|| exfPOM.getErrorRowFour().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_16)
						|| exfPOM.getErrorRowFive().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_16)
						|| exfPOM.getErrorRowSix().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_16) 
						|| exfPOM.getErrorRowSeven().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_16)
						|| exfPOM.getErrorRowEight().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_16)) {
					flag = true;
				}
				if (exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_17)
						|| exfPOM.getErrorRowOne().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_17)
						|| exfPOM.getErrorRowTwo().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_17)
						|| exfPOM.getErrorRowThree().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_17)
						|| exfPOM.getErrorRowFour().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_17)
						|| exfPOM.getErrorRowFive().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_17)
						|| exfPOM.getErrorRowSix().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_17) 
						|| exfPOM.getErrorRowSeven().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_17)
						|| exfPOM.getErrorRowEight().getText().equalsIgnoreCase(LOMTConstant.LEVEL_ROW_17)) {
					flag = true;
				}
	...
	public void searchAndExportExFFileReingestion(String lobName) {
		if (lobName.equalsIgnoreCase(LOMTConstant.HE_LOB)) {
			int counter = 0;
			String goalframeworkName = null;
			readExternalFrameworkFile = new ReadExternalFrameworkFile();
			try {
				goalframeworkName = readExternalFrameworkFile.getEXFGoalFrameworkName(LOMTConstant.HE_LOB);
				System.out.println("Goalframework name : " + goalframeworkName);
				if (goalframeworkName == null) {
					return;
				}
				// Updaing ExF goal framework title and verifying udpated data
				// in exported sheet = 0
				reingestionEXF(lobName, goalframeworkName, counter, null);
				counter++;				

				// Updating  Grade low & hight title, counter=1				
				...
				goalframeworkName = readExternalFrameworkFile.getGoalFrameworkEXF(exportedFilePath);
				reingestionEXF(lobName, goalframeworkName, counter, null);
				System.out.println("Lowest level updated");
				...
				goalframeworkName = readExternalFrameworkFile.getGoalFrameworkEXF(exportedFilePath);
				reingestionEXF(lobName, goalframeworkName, counter, LOMTConstant.EXF_WITHOUT_MANDATORY_FIELDS);
				counter++;
				System.out.println("Mandatory field checked");
				
				//Wrong Grade validation check, counter=8
				goalframeworkName = readExternalFrameworkFile.getGoalFrameworkEXF(exportedFilePath);
				reingestionEXF(lobName, goalframeworkName, counter, LOMTConstant.REINGESTION_WRONG_GRADE_SAME_LEVEL);
				counter++;
				System.out.println("Mandatory field checked");
				...
				verifyExFExportedFileOnUI(LOMTConstant.HE_LOB, obj, goalframeworkNameExp);
			} catch (Exception e) {
				e.printStackTrace();
			}
		} else {
	...
	private void reingestionEXF(String lobName, String goalframeworkName, int counter, String validationUseCase)
		...
		if (commonPOM.getWaitForIngestionStatusText().getText().equalsIgnoreCase(LOMTConstant.INGESTION_SUCESSFULL_MESSAGE)) {
			...
			if (validationUseCase.equalsIgnoreCase(LOMTConstant.EXF_WITHOUT_MANDATORY_FIELDS)) {
				boolean flag = exfValidationCheck(LOMTConstant.EXF_WITHOUT_MANDATORY_FIELDS); 
				if (flag) {
					System.out.println("Without mandatory fields messages are correct");
				} else {
					System.out.println("Without mandatory fields messages are not correct");
				 }
			}
			if (validationUseCase.equalsIgnoreCase(LOMTConstant.REINGESTION_WRONG_GRADE_SAME_LEVEL)) {
				boolean flag = exfValidationCheck(LOMTConstant.REINGESTION_WRONG_GRADE_SAME_LEVEL);
				if (flag) {
					System.out.println("Without mandatory fields messages are correct");
				} else {
					System.out.println("Without mandatory fields messages are not correct");
			...
			if (commonPOM.getShowingText().getText().contains("Showing")) {
				...
				if (llist != null) {
					for (String key : llist) {
						exfPOM.getEnterSearchTerm().sendKeys(key);
						Thread.sleep(2000);
