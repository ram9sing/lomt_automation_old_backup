...
public class EnglishGSEIngestionTestScript {
	...
	public void gseIngestion() throws Exception {
		...
		gseIngestion.createUploadStructurePageWithBackOperation();
		gseIngestion.selectBackButtonAndUploadCorrectGSESheet(LOMTConstant.FRESH_INGESTION); // it will false in Ingestion case
	...
	public void gseReingestionWithoutURN() throws Exception {
		logger = reports.startTest("English GSE Re-ingestion", "LOMT-11, TCs Passed");
		
		gseIngestion.selectBackButtonAndUploadCorrectGSESheet(LOMTConstant.RE_INGESTION_WITHOUT_URN);
	...
	public void gseReingestionWithURN() throws Exception {
		...
		gseIngestion.selectBackButtonAndUploadCorrectGSESheet(LOMTConstant.RE_INGESTION_URN);
